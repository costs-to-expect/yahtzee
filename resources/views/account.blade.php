    ...
    <body>
        ...
        <div class="col-lg-8 mx-auto p-3 py-md-5">
            <main>
                ...
                <p class="load">This will delete all your Yahtzee games and any data
                ...
                <a href="#" class="btn btn-sm btn-danger">Delete Yahtzee Account</a>

                <h3 class="mt-5">Delete Costs to Expect account</h3>

                <p class="load">This will delete your Costs to Expect account, your Yahtzee account will be
                ...
                <a href="#" class="btn btn-sm btn-danger">Delete Account</a>
